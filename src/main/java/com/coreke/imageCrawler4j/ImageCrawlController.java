package com.coreke.imageCrawler4j;
...
public class ImageCrawlController {
	...
	public static void main(String[] args) throws Exception {
		...
		String rootFolder =  "d:/crawl"; // 定义爬虫数据存储位置
		int numberOfCrawlers = 7; // 定义7个爬虫，也就是7个线程
		String storageFolder = "d:/crawl/data"; // 定义爬取的图片本地存储位置
		...
		String[] crawlDomains = {"https://www.pku.edu.cn/"};
